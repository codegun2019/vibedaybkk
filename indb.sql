...
--
-- Host: localhost:3306
-- Generation Time: Oct 15, 2025 at 10:08 PM
...
CREATE TABLE `homepage_content` (
  `id` int(11) NOT NULL,
  `section_key` varchar(50) NOT NULL,
  `content_type` enum('text','image','video','gallery') NOT NULL DEFAULT 'text',
...
(1, 'hero', 'Hero Section', 'hero', 1, 1, 'VIBEDAYBKK', 'Professional Model Agency in Bangkok', 'We provide top-tier professional models for fashion shows, events, and commercial projects. Our models are carefully selected and trained to deliver excellence.', 'ดูบริการของเรา', 'services.php', NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#1a1a1a', '#ffffff', '{\"overlay_opacity\": \"0.5\", \"text_align\": \"center\", \"animation\": \"fade-in\"}', '2025-10-14 18:44:36', '2025-10-15 17:26:19'),
(2, 'about', 'About Section', 'about', 1, 2, 'เกี่ยวกับเรา', 'มืออาชีพ ประสบการณ์สูง', 'VIBEDAYBKK เป็นเอเจนซี่โมเดลชั้นนำในกรุงเทพฯ ที่มีประสบการณ์กว่า 10 ปี ในการจัดหาโมเดลมืออาชีพสำหรับงานแฟชั่น อีเวนท์ และโฆษณา เรามีโมเดลที่ผ่านการคัดสรรและฝึกฝนมาอย่างดี พร้อมให้บริการในทุกประเภทงาน', 'อ่านเพิ่มเติม', 'about.php', NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#ffffff', '#1a1a1a', '{\"layout\": \"image-text\", \"image_position\": \"left\"}', '2025-10-14 18:44:36', '2025-10-14 18:44:36'),
(3, 'services', 'Services Section', 'services', 1, 3, 'บริการของเรา', 'หมวดหมู่โมเดลที่หลากหลาย', 'เรามีโมเดลมืออาชีพให้เลือกหลากหลายประเภท ตามความต้องการของคุณ', 'ดูทั้งหมด', 'services.php', NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#f9fafb', '#1a1a1a', '{\"columns\": \"3\", \"show_price\": true}', '2025-10-14 18:44:36', '2025-10-14 18:44:36'),
(4, 'gallery', 'Gallery Section', 'gallery', 1, 4, 'ผลงานของเรา', 'ภาพจากงานที่ผ่านมา', 'ชมผลงานและประสบการณ์ของโมเดลจากงานต่างๆ ที่เราได้ร่วมงานมา', 'ดูทั้งหมด', 'gallery.php', NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#1a1a1a', '#ffffff', '{\"columns\": \"4\", \"lightbox\": true, \"autoplay\": false}', '2025-10-14 18:44:36', '2025-10-14 18:44:36'),
(5, 'testimonials', 'Testimonials Section', 'testimonials', 1, 5, 'ความคิดเห็นจากลูกค้า', 'สิ่งที่ลูกค้าพูดถึงเรา', 'เราภูมิใจที่ได้รับความไว้วางใจจากลูกค้ามากมาย', NULL, NULL, NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#ffffff', '#1a1a1a', '{\"carousel\": true, \"autoplay\": true, \"interval\": \"5000\"}', '2025-10-14 18:44:36', '2025-10-14 18:44:36'),
(6, 'stats', 'Statistics Section', 'stats', 1, 6, 'ตัวเลขที่น่าประทับใจ', NULL, NULL, NULL, NULL, NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#dc2626', '#ffffff', '{\"columns\": \"4\"}', '2025-10-14 18:44:36', '2025-10-14 18:44:36'),
(7, 'cta', 'Call to Action', 'cta', 1, 7, 'พร้อมเริ่มโปรเจกต์กับเราแล้วหรือยัง?', 'ติดต่อเราวันนี้เพื่อรับคำปรึกษาฟรี', 'ทีมงานของเราพร้อมให้คำแนะนำและหาโมเดลที่เหมาะสมกับงานของคุณ', 'ติดต่อเรา', 'contact.php', NULL, 'center', 'cover', 'no-repeat', 'scroll', NULL, '0.50', '#dc2626', '#ffffff', '{\"button_style\": \"large\", \"show_phone\": true}', '2025-10-14 18:44:36', '2025-10-14 18:44:36');
...
(1, 1, 'FM001', 'สุภาพร สวยงาม', 'Supaporn Suayngam', 'โมเดลมืออาชีพ มีประสบการณ์ในงานแฟชั่นโชว์และถ่ายแบบ', '3000.00', '5000.00', 170, 48, 34, 24, 36, 5, 25, 'ขาว', 'ดำ', 'น้ำตาล', 'ไทย, อังกฤษ', 'เดินรันเวย์, ถ่ายแบบ, MC', 1, 'available', 0, 0, '0.00', 1, '2025-10-14 19:50:44', '2025-10-14 19:50:44'),
...
(4, 2, 'MM001', 'ธนพล หล่อเหลา', 'Thanapol Lolao', 'โมเดลชายมืออาชีพ รูปร่างสมส่วน', '3000.00', '5000.00', 180, 70, NULL, NULL, NULL, 6, 28, 'ขาวเหลือง', 'ดำ', 'น้ำตาล', 'ไทย, อังกฤษ', 'เดินรันเวย์, ถ่ายแบบ, แอคติ้ง', 1, 'available', 0, 0, '0.00', 4, '2025-10-14 19:50:44', '2025-10-14 19:50:44'),
...
(11, 'logo_image', '', 'text', 'รูปภาพโลโก้', '2025-10-14 17:42:37', '2025-10-14 17:42:37'),
(12, 'favicon', '', 'text', 'Favicon', '2025-10-14 17:42:37', '2025-10-14 17:42:37'),
(44, 'social_facebook_url', 'https://facebook.com/vibedaybkk', 'text', 'Facebook URL', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(45, 'social_facebook_icon', 'fa-facebook-f', 'text', 'Facebook Icon', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(46, 'social_facebook_enabled', '1', 'boolean', 'Enable Facebook', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(47, 'social_instagram_url', 'https://instagram.com/vibedaybkk', 'text', 'Instagram URL', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(48, 'social_instagram_icon', 'fa-instagram', 'text', 'Instagram Icon', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(49, 'social_instagram_enabled', '1', 'boolean', 'Enable Instagram', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
...
(52, 'social_twitter_enabled', '1', 'boolean', 'Enable Twitter', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(53, 'social_line_url', 'https://line.me/ti/p/@vibedaybkk', 'text', 'LINE URL', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(54, 'social_line_icon', 'fa-line', 'text', 'LINE Icon', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(55, 'social_line_enabled', '0', 'boolean', 'Enable LINE', '2025-10-14 21:25:49', '2025-10-15 17:36:04'),
(56, 'social_youtube_url', 'https://youtube.com/@vibedaybkk', 'text', 'YouTube URL', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(57, 'social_youtube_icon', 'fa-youtube', 'text', 'YouTube Icon', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(58, 'social_youtube_enabled', '0', 'boolean', 'Enable YouTube', '2025-10-14 21:25:49', '2025-10-15 17:36:02'),
(59, 'social_tiktok_url', 'https://tiktok.com/@vibedaybkk', 'text', 'TikTok URL', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(60, 'social_tiktok_icon', 'fa-tiktok', 'text', 'TikTok Icon', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(61, 'social_tiktok_enabled', '0', 'boolean', 'Enable TikTok', '2025-10-14 21:25:49', '2025-10-15 17:36:01'),
...
(67, 'theme_primary_color', '#DC2626', 'text', 'Primary Theme Color (Red)', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(68, 'theme_secondary_color', '#1F2937', 'text', 'Secondary Theme Color (Dark Gray)', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(69, 'theme_accent_color', '#F59E0B', 'text', 'Accent Theme Color (Orange)', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(70, 'theme_background_color', '#0F172A', 'text', 'Background Color (Dark)', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
(71, 'theme_text_color', '#F3F4F6', 'text', 'Text Color (Light Gray)', '2025-10-14 21:25:49', '2025-10-14 21:25:49'),
...
(1, 'admin', '$2y$10$Fbetghb9CInguhgrkxwHfeRdqOpbG19qUE3D.GVOj0p8T0IpVjF4a', 'ผู้ดูแลระบบ', 'admin@vibedaybkk.com', 'programmer', 'active', '2025-10-16 01:25:24', '2025-10-14 16:48:03', '2025-10-15 18:25:24'),
